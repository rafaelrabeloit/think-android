...
public class CustomHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	 ...
	 */
	public CustomHttpMessageConverter(boolean serializeNulls) {
	 ...
	 */
	public CustomHttpMessageConverter(Gson gson) {
	...
	protected void writeInternal(Object o, HttpOutputMessage outputMessage)
		...
		try {
			...
			if (typeOfSrc != null) {
			    ...
			    jsonObject.add(o.getClass().getSimpleName().toLowerCase(), jsonElement);
